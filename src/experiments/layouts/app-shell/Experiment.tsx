...
// Section `label` / `body` is the demo's content; kept grouped here for the same reason as `copy`.
const SECTIONS = [
    ...
    <div className="overflow-hidden rounded-card border border-border bg-surface">
      <div className="flex min-h-[28rem] flex-col md:flex-row">
        <aside className="border-b border-border bg-canvas p-4 md:w-56 md:border-r md:border-b-0">
          <p className="px-2 pb-3 text-sm font-semibold text-ink">{copy.workspaceName}</p>
          <nav className="flex gap-1 overflow-x-auto md:flex-col">{navButtons}</nav>
        </aside>
